...
hidden if the `sabat-framework_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `sabat-framework_DEVELOPER_MODE` to the configure
...
Runs the executable target `sabat-framework_exe`.
